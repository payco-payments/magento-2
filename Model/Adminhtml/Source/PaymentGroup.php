...
namespace Payco\Payments\Model\Adminhtml\Source;
...
/**
 * Class PaymentGroup - Fieldset renderer for Payco Payments.
 *
...
class PaymentGroup extends Fieldset
{
    ...
    protected function _getHeaderTitleHtml($element)
    {
        ...
        $html .= /* @noEscape */ $this->secureRenderer->renderEventListenerAsTag(
            'onclick',
            "paycopaymentsToggleSolution.call(this, '".$htmlId."', '".$this->getUrl('adminhtml/*/state').
    ...
    protected function _getExtraJs($element)
    {
        $script = "require(['jquery', 'prototype'], function(jQuery){
            window.paycopaymentsToggleSolution = function (id, url) {
                var doScroll = false;
